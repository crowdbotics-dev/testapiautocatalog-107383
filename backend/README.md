...
## Project Structure
    ...
    ├── testapiautocatalog_107383  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_107383`
...
2. Clone this repo and `cd testapiautocatalog_107383`
